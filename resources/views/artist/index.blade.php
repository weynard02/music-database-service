        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="/artists" method="GET">   
                ...
                <div class="relative">
                    ...
                    <input type="search" name="artist" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required>
            ...
            <a href="/artists/{{$i->id}}" class="my-5 block max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                @unless($i->description === 'TBA')
                <p class="mb-2 text-sm tracking-tight text-gray-900 dark:text-slate-400">{{$i->description}}</p>
                @endunless
            </a>
            @endforeach
        </div>
